...
namespace ControlFlowExercises
{
    class Program
    {
        ...
        {
            Console.WriteLine("Please enter width for the image");
            var width = Convert.ToInt32(Console.ReadLine());
            Console.WriteLine("PLease enter height for the image");
        ...
        //the number of demerit points. For every 5km/hr above the speed limit, 1 demerit points should be incurred and displayed on the console. 
